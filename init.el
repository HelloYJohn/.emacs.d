...
(add-to-list 'load-path (expand-file-name "~/.emacs.d/john-elpa/mode-icons/"))
(require 'tabbar-ruler)
(setq tabbar-ruler-global-tabbar t)
;;; (setq tabbar-ruler-global-ruler t)  ; display column
(global-set-key (kbd "M-m") 'tabbar-ruler-forward)
(global-set-key (kbd "M-o") 'tabbar-ruler-backward)
...
;;; magit
(add-to-list 'load-path "/home/john/.emacs.d/site-lisp/magit/lisp")
(require 'magit)

(with-eval-after-load 'info
  (info-initialize)
  (add-to-list 'Info-directory-list
               "/home/john/.emacs.d/site-lisp/magit/Documentation/"))
;;; delete whiteblank
